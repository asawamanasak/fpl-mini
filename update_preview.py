  ...
  <style>
    ...
    * {
    ...
    @keyframes tabBoxPulse {
      ...
      50% {
        box-shadow: 0 0 12px 3px rgba(59, 130, 246, 0.65);
        border-color: rgba(37, 99, 235, 1);
        background-color: rgba(59, 130, 246, 0.22);
      }
    }
    @keyframes tabBoxPulseActive {
      0%, 100% {
    ...
    .tab-pulse-live {
      animation: tabBoxPulse 1.5s cubic-bezier(0.4, 0, 0.6, 1) infinite !important;
      border: 1px solid rgba(59, 130, 246, 0.8) !important;
    }
    .tab-pulse-live.bg-slate-900 {
      animation: tabBoxPulseActive 1.5s cubic-bezier(0.4, 0, 0.6, 1) infinite !important;
    }
  ...
  <script>
    ...
    class StandaloneApp {
      ...
      updateHighlightsTabBlink() {
        ...
        // กล่อง Tab จะกะพริบจนกว่าจะสรุปจบ Gameweek
        if (!isFinished) {
          tabBtn.classList.add('tab-pulse-live');
        } else {
          tabBtn.classList.remove('tab-pulse-live');
        }
      }
