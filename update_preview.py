  ...
  <script>
    ...
    class StandaloneApp {
      ...
      renderHighlightsView() {
        ...
        // Minimal Card builder helper (No subtitles, minimal readable layout)
        const renderCard = (cfg) => {
          ...
          if (cfg.theme === 'green') {
            iconBg = 'bg-emerald-100/80 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300';
            ...
            iconBg = 'bg-rose-100/80 text-rose-700 dark:bg-rose-900/50 dark:text-rose-300';
            ...
            iconBg = 'bg-indigo-100/80 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300';
          ...
          if (!cfg.winner) {
            return `
              <div class="glass-card rounded-2xl p-3.5 sm:p-4 border border-slate-200/80 dark:border-slate-800/80 flex flex-col justify-between transition-all">
                <div class="flex items-center gap-2.5">
                  <span class="w-7 h-7 rounded-lg flex items-center justify-center text-sm flex-shrink-0 ${iconBg}">
                    ${cfg.icon}
                  </span>
          ...
          return `
            <div class="glass-card rounded-2xl p-3.5 sm:p-4 border border-slate-200/80 dark:border-slate-800/80 flex flex-col justify-between transition-all ${cardHover}">
              ...
              <!-- Header: Icon & Title Only (No Subtitle) -->
